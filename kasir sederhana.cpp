...
int main()
{
	...
	if (menu_makan == '1')
    {
        ...
        cout << "Mie ayam " << jumlah_porsi << " mangkok " <<"RP "<< total_makan<< endl;
        nama_makan = "Mie Ayam";
    }
    else if (menu_makan == '2')
    {
        total_makan = jumlah_porsi * 13000;
        cout << "Bakso " << jumlah_porsi << " mangkok " <<"RP "<< total_makan<< endl;
        nama_makan = "Bakso";
    }
    else if (menu_makan == '3')
    {
        total_makan = jumlah_porsi * 15000;
        cout << "Nasi Goreng " << jumlah_porsi << " mangkok " <<"RP "<< total_makan<< endl;
	...
	if (menu_minuman == '1')
	{
		...
		cout<<"Teh Tarik "<<jumlah_minuman<<" gelas "<<"RP "<<total_minuman<<endl;
		nama_minuman = "Teh Tarik";
	}
		else if (menu_minuman == '2')
			{
				total_minuman = jumlah_minuman *3000;
				cout<<"Es Teh "<<jumlah_minuman<<" Gelas "<<"RP "<<total_minuman<<endl;
				nama_minuman = "Es teh";
			}	
		else if (menu_minuman == '3')
			{
				total_minuman = jumlah_minuman * 5000;
				cout<<"Es Jeruk " << jumlah_minuman <<" Gelas " <<"RP "<<total_minuman<<endl;
